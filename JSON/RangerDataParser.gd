...
static func set_char_config(char_config:CharacterConfig, ranger_data, tape1=null, tape2=null, tape3=null, own_tapes:bool = true):
	...
	tape1 = tape1 if tape1 != null else load("res://mods/RangerArena/Scripts/CustomRangerTapeConfig.gd").instance()
	tape2 = tape2 if tape2 != null else load("res://mods/RangerArena/Scripts/CustomRangerRandomTapeConfig.gd").instance()
	tape3 = tape3 if tape3 != null else load("res://mods/RangerArena/Scripts/CustomRangerRandomTapeConfig.gd").instance()
